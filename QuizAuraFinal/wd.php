...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Web Development</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Web Development">
    <question text="What does HTML stand for in the context of web development?">
        <option alpha="a" text="HyperText Markup Language" correct="true" />
        <option alpha="b" text="High-Level Text Language" correct="false" />
        <option alpha="c" text="Hyperlink and Text Markup Language" correct="false" />
        <option alpha="d" text="High-Level Markup Language" correct="false" />
    </question>
    <question text="What is the purpose of CSS (Cascading Style Sheets) in web development?">
        <option alpha="a" text="To define the structure and content of a web page" correct="false" />
        <option alpha="b" text="To provide a server-side scripting language" correct="false" />
        <option alpha="c" text="To enhance the visual presentation and layout of HTML elements" correct="true" />
        <option alpha="d" text="To manage database interactions on a website" correct="false" />
    </question>
    <question text="What is JavaScript in the context of web development?">
        <option alpha="a" text="A style sheet language for describing the look and formatting of a document written in a markup language" correct="false" />
        <option alpha="b" text="A programming language that enables interactive web pages" correct="true" />
        <option alpha="c" text="A markup language for creating structured documents" correct="false" />
        <option alpha="d" text="A database management system for web applications" correct="false" />
    </question>
    <question text="What is the purpose of a server in web development?">
        <option alpha="a" text="To store and manage the client's web browser settings" correct="false" />
        <option alpha="b" text="To provide a visual representation of a web page" correct="false" />
        <option alpha="c" text="To process and respond to client requests, delivering web pages and resources" correct="true" />
        <option alpha="d" text="To execute client-side scripts in a web page" correct="false" />
    </question>
    <question text="What does the term 'responsive design' mean in web development?">
        <option alpha="a" text="Designing web pages that respond to user input" correct="false" />
        <option alpha="b" text="Designing web pages that load quickly" correct="false" />
        <option alpha="c" text="Designing web pages that adapt to different screen sizes and devices" correct="true" />
        <option alpha="d" text="Designing web pages that prioritize security" correct="false" />
    </question>
</quiz>
