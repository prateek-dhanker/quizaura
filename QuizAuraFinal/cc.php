...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Cloud Computing</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Cloud Computing">
    <question text="What is the main advantage of cloud computing?">
        <option alpha="a" text="Increased security" correct="false" />
        <option alpha="b" text="Decreased accessibility" correct="false" />
        <option alpha="c" text="Cost savings, scalability, and flexibility" correct="true" />
        <option alpha="d" text="Limited storage options" correct="false" />
    </question>
    <question text="What is Infrastructure as a Service (IaaS) in cloud computing?">
        <option alpha="a" text="A service that provides ready-to-use software applications over the internet" correct="false" />
        <option alpha="b" text="A service that delivers computing infrastructure over the internet, such as virtual machines and storage" correct="true" />
        <option alpha="c" text="A service that focuses on the development and deployment of applications in the cloud" correct="false" />
        <option alpha="d" text="A service that offers a platform for building, testing, and deploying applications" correct="false" />
    </question>
    <question text="What is the role of a load balancer in cloud computing?">
        <option alpha="a" text="To limit the number of users accessing a cloud service" correct="false" />
        <option alpha="b" text="To evenly distribute incoming network traffic across multiple servers or resources" correct="true" />
        <option alpha="c" text="To restrict access to sensitive data in the cloud" correct="false" />
        <option alpha="d" text="To optimize the speed of data transfer in a cloud network" correct="false" />
    </question>
    <question text="What is a public cloud in the context of cloud computing?">
        <option alpha="a" text="A cloud infrastructure dedicated to a single organization" correct="false" />
        <option alpha="b" text="A cloud infrastructure shared by multiple organizations, and resources are made available to the general public" correct="true" />
        <option alpha="c" text="A cloud deployment model that combines aspects of both public and private clouds" correct="false" />
        <option alpha="d" text="A cloud service that is only accessible from a specific geographic location" correct="false" />
    </question>
    <question text="What is a hybrid cloud in cloud computing?">
        <option alpha="a" text="A cloud infrastructure dedicated to a single organization" correct="false" />
        <option alpha="b" text="A cloud deployment model that combines aspects of both public and private clouds" correct="true" />
        <option alpha="c" text="A cloud infrastructure shared by multiple organizations, and resources are made available to the general public" correct="false" />
        <option alpha="d" text="A cloud service that is only accessible from a specific geographic location" correct="false" />
    </question>
</quiz>
