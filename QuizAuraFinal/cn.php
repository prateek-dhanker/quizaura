...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Computer Networks</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Computer Networks">
    <question text="What is the purpose of an IP address in computer networks?">
        <option alpha="a" text="To identify the manufacturer of a network device" correct="false" />
        <option alpha="b" text="To uniquely identify a device on a network" correct="true" />
        <option alpha="c" text="To encrypt data during transmission" correct="false" />
        <option alpha="d" text="To determine the speed of the network connection" correct="false" />
    </question>
    <question text="What is the function of the OSI model in computer networks?">
        <option alpha="a" text="To define the structure of a computer program" correct="false" />
        <option alpha="b" text="To provide a conceptual framework for understanding network functions" correct="true" />
        <option alpha="c" text="To secure network communications" correct="false" />
        <option alpha="d" text="To manage network resources" correct="false" />
    </question>
    <question text="What is a firewall in the context of computer networks?">
        <option alpha="a" text="A device for connecting two different network types" correct="false" />
        <option alpha="b" text="A software or hardware system that monitors and controls incoming and outgoing network traffic" correct="true" />
        <option alpha="c" text="A protocol for secure data transfer" correct="false" />
        <option alpha="d" text="A tool for measuring the speed of a network connection" correct="false" />
    </question>
    <question text="What is the purpose of the DNS (Domain Name System) in computer networks?">
        <option alpha="a" text="To encrypt data during transmission" correct="false" />
        <option alpha="b" text="To translate human-readable domain names into IP addresses" correct="true" />
        <option alpha="c" text="To manage network security" correct="false" />
        <option alpha="d" text="To compress data for faster transmission" correct="false" />
    </question>
    <question text="What is a LAN (Local Area Network) in computer networks?">
        <option alpha="a" text="A network that covers a large geographic area" correct="false" />
        <option alpha="b" text="A network that connects computers within a limited area, such as a single building or campus" correct="true" />
        <option alpha="c" text="A network protocol for wireless communication" correct="false" />
        <option alpha="d" text="A network topology for connecting multiple networks" correct="false" />
    </question>
</quiz>
