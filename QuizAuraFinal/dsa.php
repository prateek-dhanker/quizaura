...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Data Structure & Algorithm</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Data Structures and Algorithms">
    <question text="What is the purpose of a stack in data structures?">
        <option alpha="a" text="To store elements in a sorted order" correct="false" />
        <option alpha="b" text="To implement recursion" correct="false" />
        <option alpha="c" text="To store elements in a Last-In-First-Out (LIFO) order" correct="true" />
        <option alpha="d" text="To store elements in a First-In-First-Out (FIFO) order" correct="false" />
    </question>
    <question text="What is the time complexity of the quicksort algorithm in the average case?">
        <option alpha="a" text="O(n)" correct="false" />
        <option alpha="b" text="O(n log n)" correct="true" />
        <option alpha="c" text="O(n^2)" correct="false" />
        <option alpha="d" text="O(log n)" correct="false" />
    </question>
    <question text="What is the purpose of binary search in algorithms?">
        <option alpha="a" text="To search for an element in a sorted list efficiently" correct="true" />
        <option alpha="b" text="To sort elements in ascending order" correct="false" />
        <option alpha="c" text="To search for an element in an unsorted list efficiently" correct="false" />
        <option alpha="d" text="To perform mathematical operations on binary numbers" correct="false" />
    </question>
    <question text="What is a linked list in data structures?">
        <option alpha="a" text="A linear data structure with a fixed size" correct="false" />
        <option alpha="b" text="A collection of elements with no specific order" correct="false" />
        <option alpha="c" text="A data structure consisting of nodes where each node points to the next node in the sequence" correct="true" />
        <option alpha="d" text="An unordered collection of key-value pairs" correct="false" />
    </question>
    <question text="Which sorting algorithm has the best time complexity in the worst case?">
        <option alpha="a" text="Bubble Sort" correct="false" />
        <option alpha="b" text="Selection Sort" correct="false" />
        <option alpha="c" text="Merge Sort" correct="true" />
        <option alpha="d" text="Insertion Sort" correct="false" />
    </question>
</quiz>
