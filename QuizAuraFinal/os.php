...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Operating System</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Operating Systems">
    <question text="What is the main function of an operating system?">
        <option alpha="a" text="To provide a user interface" correct="false" />
        <option alpha="b" text="To manage hardware resources and provide services for computer programs" correct="true" />
        <option alpha="c" text="To perform arithmetic calculations" correct="false" />
        <option alpha="d" text="To store and retrieve data" correct="false" />
    </question>
    <question text="What is the purpose of virtual memory in an operating system?">
        <option alpha="a" text="To create virtual machines for running multiple operating systems" correct="false" />
        <option alpha="b" text="To provide a secure environment for executing applications" correct="false" />
        <option alpha="c" text="To expand the available RAM by using a portion of the hard disk" correct="true" />
        <option alpha="d" text="To manage the network connections of the computer" correct="false" />
    </question>
    <question text="What is a process in the context of operating systems?">
        <option alpha="a" text="A program in execution, including its current state" correct="true" />
        <option alpha="b" text="A storage device for long-term data retention" correct="false" />
        <option alpha="c" text="A peripheral device connected to the computer" correct="false" />
        <option alpha="d" text="A user interface for interacting with the operating system" correct="false" />
    </question>
    <question text="What is the role of the scheduler in an operating system?">
        <option alpha="a" text="To manage the file system" correct="false" />
        <option alpha="b" text="To allocate system resources to processes" correct="true" />
        <option alpha="c" text="To control input and output devices" correct="false" />
        <option alpha="d" text="To provide a graphical user interface" correct="false" />
    </question>
    <question text="What is a deadlock in the context of operating systems?">
        <option alpha="a" text="A situation where a process is waiting for a resource held by another process, and vice versa" correct="true" />
        <option alpha="b" text="A failure in the file system that results in data loss" correct="false" />
        <option alpha="c" text="A security breach that allows unauthorized access to the system" correct="false" />
        <option alpha="d" text="A hardware malfunction that causes the system to crash" correct="false" />
    </question>
</quiz>
