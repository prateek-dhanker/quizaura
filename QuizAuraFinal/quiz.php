...
<html lang="en">
  <head>
    ...
    cursor: pointer;
      ...
      #myModal {
        ...
        top: 15%;
        left: 15%;
        /* background-color: rgb(123, 210, 229); */
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - General Knowledge</div>
    </div>
      ...
      const xmlString = `
          <quiz subName="GK">
            <question text="What is the capital of France?">
                <option alpha="a" text="Berlin" correct="false" />
                <option alpha="b" text="Madrid" correct="false" />
                <option alpha="c" text="Paris" correct="true" />
                <option alpha="d" text="Rome" correct="false" />
            </question>
            <question text="Which planet is known as the Red Planet?">
                <option alpha="a" text="Mars" correct="true" />
                <option alpha="b" text="Jupiter" correct="false" />
                <option alpha="c" text="Venus" correct="false" />
                <option alpha="d" text="Earth" correct="false" />
            </question>
            <question text="What is the largest mammal on Earth?">
                <option alpha="a" text="Elephant" correct="false" />
                <option alpha="b" text="Giraffe" correct="false" />
                <option alpha="c" text="Blue Whale" correct="true" />
                <option alpha="d" text="Lion" correct="false" />
            </question>
            <question text="Who wrote 'Romeo and Juliet'?">
                <option alpha="a" text="William Shakespeare" correct="true" />
                <option alpha="b" text="Charles Dickens" correct="false" />
                <option alpha="c" text="Jane Austen" correct="false" />
                <option alpha="d" text="Mark Twain" correct="false" />
            </question>
            <question text="In which year did World War II end?">
                <option alpha="a" text="1943" correct="false" />
                <option alpha="b" text="1945" correct="true" />
                <option alpha="c" text="1950" correct="false" />
                <option alpha="d" text="1939" correct="false" />
            </question>
        </quiz>
