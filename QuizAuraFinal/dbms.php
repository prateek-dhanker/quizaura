...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Database management system</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="DBMS">
    <question text="What does ACID stand for in the context of database transactions?">
        <option alpha="a" text="All Conditions In Data" correct="false" />
        <option alpha="b" text="Atomicity, Consistency, Isolation, Durability" correct="true" />
        <option alpha="c" text="Aggregate, Concurrency, Integrity, Data" correct="false" />
        <option alpha="d" text="Automatic, Controlled, Indexed, Distributed" correct="false" />
    </question>
    <question text="What is the primary purpose of a foreign key in a relational database?">
        <option alpha="a" text="To ensure data consistency within a table" correct="false" />
        <option alpha="b" text="To uniquely identify each record in a table" correct="false" />
        <option alpha="c" text="To establish a link between tables by referencing the primary key of another table" correct="true" />
        <option alpha="d" text="To speed up query performance" correct="false" />
    </question>
    <question text="What is normalization in the context of database design?">
        <option alpha="a" text="A process of removing duplicate records from a table" correct="false" />
        <option alpha="b" text="A process of organizing data to minimize redundancy and dependency" correct="true" />
        <option alpha="c" text="A process of adding indices to improve query performance" correct="false" />
        <option alpha="d" text="A process of converting data into a different format for storage" correct="false" />
    </question>
    <question text="What is a stored procedure in a database?">
        <option alpha="a" text="A temporary table for storing intermediate results" correct="false" />
        <option alpha="b" text="A predefined, reusable set of SQL statements" correct="true" />
        <option alpha="c" text="An index on a column for faster searching" correct="false" />
        <option alpha="d" text="A mechanism for encrypting sensitive data" correct="false" />
    </question>
    <question text="What is the purpose of the SQL SELECT statement in a database?">
        <option alpha="a" text="To update records in a table" correct="false" />
        <option alpha="b" text="To insert new records into a table" correct="false" />
        <option alpha="c" text="To retrieve data from one or more tables" correct="true" />
        <option alpha="d" text="To delete records from a table" correct="false" />
    </question>
</quiz>
