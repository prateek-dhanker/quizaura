...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Data Mining and Warehousing</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Data Mining">
    <question text="What is data mining?">
        <option alpha="a" text="The process of storing and managing large volumes of data" correct="false" />
        <option alpha="b" text="The extraction of useful patterns and knowledge from large datasets" correct="true" />
        <option alpha="c" text="The process of transforming raw data into a more structured format" correct="false" />
        <option alpha="d" text="The analysis of historical data to predict future trends" correct="false" />
    </question>
    <question text="What is clustering in the context of data mining?">
        <option alpha="a" text="The process of organizing data into predefined categories" correct="false" />
        <option alpha="b" text="The identification of groups of similar objects within a dataset" correct="true" />
        <option alpha="c" text="The process of summarizing data to reduce its dimensionality" correct="false" />
        <option alpha="d" text="The analysis of time-series data to detect patterns over time" correct="false" />
    </question>
    <question text="What is association rule mining in data mining?">
        <option alpha="a" text="The process of predicting numerical values based on historical data" correct="false" />
        <option alpha="b" text="The identification of interesting relationships between variables in large datasets" correct="true" />
        <option alpha="c" text="The analysis of spatial data to discover geographic patterns" correct="false" />
        <option alpha="d" text="The process of classifying data into predefined categories" correct="false" />
    </question>
    <question text="What is the goal of outlier detection in data mining?">
        <option alpha="a" text="To identify patterns and associations within the data" correct="false" />
        <option alpha="b" text="To detect unusual or rare instances that deviate from the norm" correct="true" />
        <option alpha="c" text="To summarize and reduce the dimensionality of the data" correct="false" />
        <option alpha="d" text="To predict future trends based on historical data" correct="false" />
    </question>
    <question text="What is classification in data mining?">
        <option alpha="a" text="The process of organizing data into predefined categories" correct="true" />
        <option alpha="b" text="The analysis of time-series data to detect patterns over time" correct="false" />
        <option alpha="c" text="The process of summarizing data to reduce its dimensionality" correct="false" />
        <option alpha="d" text="The identification of groups of similar objects within a dataset" correct="false" />
    </question>
</quiz>
