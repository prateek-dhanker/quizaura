...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Compiler Design</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Compiler Design">
    <question text="What is the purpose of a compiler in computer science?">
        <option alpha="a" text="To execute machine code directly on the hardware" correct="false" />
        <option alpha="b" text="To translate high-level programming code into machine code for a specific architecture" correct="true" />
        <option alpha="c" text="To interpret and execute code line by line" correct="false" />
        <option alpha="d" text="To optimize the performance of a program during runtime" correct="false" />
    </question>
    <question text="What is lexical analysis in the context of compiler design?">
        <option alpha="a" text="The analysis of the program structure and logic" correct="false" />
        <option alpha="b" text="The process of converting high-level programming code into machine code" correct="false" />
        <option alpha="c" text="The analysis of the program to identify and categorize tokens" correct="true" />
        <option alpha="d" text="The optimization of code for better performance" correct="false" />
    </question>
    <question text="What is syntax analysis in compiler design?">
        <option alpha="a" text="The analysis of the program to identify and categorize tokens" correct="false" />
        <option alpha="b" text="The optimization of code for better performance" correct="false" />
        <option alpha="c" text="The process of converting high-level programming code into machine code" correct="false" />
        <option alpha="d" text="The analysis of the program structure to determine its grammatical correctness" correct="true" />
    </question>
    <question text="What is the symbol table in compiler design?">
        <option alpha="a" text="A table that stores the symbols used in a program and their memory addresses" correct="true" />
        <option alpha="b" text="A table that stores the binary representation of the program" correct="false" />
        <option alpha="c" text="A table that stores the syntax rules of a programming language" correct="false" />
        <option alpha="d" text="A table that stores the intermediate code generated during compilation" correct="false" />
    </question>
    <question text="What is code optimization in compiler design?">
        <option alpha="a" text="The analysis of the program structure to determine its grammatical correctness" correct="false" />
        <option alpha="b" text="The process of converting high-level programming code into machine code" correct="false" />
        <option alpha="c" text="The optimization of code for better performance" correct="true" />
        <option alpha="d" text="The analysis of the program to identify and categorize tokens" correct="false" />
    </question>
</quiz>
