...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Machine Learning</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Machine Learning">
    <question text="What is supervised learning in machine learning?">
        <option alpha="a" text="A type of learning where the algorithm learns by itself without any guidance" correct="false" />
        <option alpha="b" text="A type of learning where the algorithm learns from labeled training data, making predictions or decisions without human intervention" correct="true" />
        <option alpha="c" text="A type of learning where the algorithm learns from its own mistakes and adjusts its behavior" correct="false" />
        <option alpha="d" text="A type of learning where the algorithm learns by interacting with its environment" correct="false" />
    </question>
    <question text="What is unsupervised learning in machine learning?">
        <option alpha="a" text="A type of learning where the algorithm learns from labeled training data, making predictions or decisions without human intervention" correct="false" />
        <option alpha="b" text="A type of learning where the algorithm learns from its own mistakes and adjusts its behavior" correct="false" />
        <option alpha="c" text="A type of learning where the algorithm learns by itself without any guidance" correct="false" />
        <option alpha="d" text="A type of learning where the algorithm learns from unlabeled data, discovering patterns and relationships" correct="true" />
    </question>
    <question text="What is overfitting in the context of machine learning?">
        <option alpha="a" text="An algorithm that is too simple and fails to capture the underlying patterns in the data" correct="false" />
        <option alpha="b" text="An algorithm that performs well on the training data but fails to generalize to new, unseen data" correct="true" />
        <option alpha="c" text="An algorithm that is too complex and memorizes the training data" correct="false" />
        <option alpha="d" text="An algorithm that achieves perfect accuracy on both training and testing data" correct="false" />
    </question>
    <question text="What is reinforcement learning in machine learning?">
        <option alpha="a" text="A type of learning where the algorithm learns from labeled training data, making predictions or decisions without human intervention" correct="false" />
        <option alpha="b" text="A type of learning where the algorithm learns from its own mistakes and adjusts its behavior" correct="false" />
        <option alpha="c" text="A type of learning where the algorithm learns by interacting with its environment and receiving feedback in the form of rewards or penalties" correct="true" />
        <option alpha="d" text="A type of learning where the algorithm learns from unlabeled data, discovering patterns and relationships" correct="false" />
    </question>
    <question text="What is the role of a loss function in machine learning?">
        <option alpha="a" text="To measure the accuracy of a model on the training data" correct="false" />
        <option alpha="b" text="To quantify the difference between the predicted values and the actual values" correct="true" />
        <option alpha="c" text="To regularize the model and prevent overfitting" correct="false" />
        <option alpha="d" text="To evaluate the model's performance on unseen data" correct="false" />
    </question>
</quiz>
