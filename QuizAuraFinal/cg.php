...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - Computer Graphics</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Computer Graphics">
    <question text="What is rasterization in computer graphics?">
        <option alpha="a" text="A technique for rendering 3D models using ray tracing" correct="false" />
        <option alpha="b" text="A process of converting vector graphics into pixels for display" correct="true" />
        <option alpha="c" text="A method for compressing images to reduce file size" correct="false" />
        <option alpha="d" text="A shading technique for simulating realistic lighting in 3D scenes" correct="false" />
    </question>
    <question text="What is the purpose of anti-aliasing in computer graphics?">
        <option alpha="a" text="To add artificial colors to an image for visual enhancement" correct="false" />
        <option alpha="b" text="To reduce jagged edges in images caused by pixelation" correct="true" />
        <option alpha="c" text="To simulate realistic shadows in 3D scenes" correct="false" />
        <option alpha="d" text="To apply textures to 3D models for added realism" correct="false" />
    </question>
    <question text="What is a shader in computer graphics?">
        <option alpha="a" text="A program that converts 3D models into 2D images" correct="false" />
        <option alpha="b" text="A software tool for creating 3D models" correct="false" />
        <option alpha="c" text="A program that controls the appearance of pixels in a rendered image" correct="true" />
        <option alpha="d" text="A hardware device for displaying graphics on a monitor" correct="false" />
    </question>
    <question text="What is the role of a GPU (Graphics Processing Unit) in computer graphics?">
        <option alpha="a" text="To store and retrieve graphical assets for rendering" correct="false" />
        <option alpha="b" text="To provide a user interface for interacting with graphical elements" correct="false" />
        <option alpha="c" text="To perform complex calculations and rendering tasks, freeing up the CPU for other tasks" correct="true" />
        <option alpha="d" text="To connect the computer to external display devices" correct="false" />
    </question>
    <question text="What is ray tracing in computer graphics?">
        <option alpha="a" text="A technique for rendering 3D models using rasterization" correct="false" />
        <option alpha="b" text="A method for creating realistic shadows and reflections by simulating the behavior of light rays" correct="true" />
        <option alpha="c" text="A process of converting vector graphics into pixels for display" correct="false" />
        <option alpha="d" text="A shading technique for simulating realistic lighting in 3D scenes" correct="false" />
    </question>
</quiz>
