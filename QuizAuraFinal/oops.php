...
<html lang="en">
  ...
  <body>
    ...
    <div class="sub" style="font-size: 19px">Subject - OOPs</div>
    </div>
    ...
    function getCorrectAnswer(questionNumber) {
      ...
      const xmlString = `
      <quiz subName="Object-Oriented Programming (OOP)">
    <question text="What is encapsulation in object-oriented programming?">
        <option alpha="a" text="The process of breaking down a complex problem into smaller, more manageable parts" correct="false" />
        <option alpha="b" text="The ability to hide the internal details of an object and only expose the necessary functionality" correct="true" />
        <option alpha="c" text="The process of defining a new class based on an existing class" correct="false" />
        <option alpha="d" text="The ability of an object to take on multiple forms" correct="false" />
    </question>
    <question text="What is inheritance in object-oriented programming?">
        <option alpha="a" text="The process of creating a new class based on an existing class" correct="true" />
        <option alpha="b" text="The ability of an object to take on multiple forms" correct="false" />
        <option alpha="c" text="The process of breaking down a complex problem into smaller, more manageable parts" correct="false" />
        <option alpha="d" text="The ability to hide the internal details of an object" correct="false" />
    </question>
    <question text="What is polymorphism in object-oriented programming?">
        <option alpha="a" text="The process of creating a new class based on an existing class" correct="false" />
        <option alpha="b" text="The ability to hide the internal details of an object" correct="false" />
        <option alpha="c" text="The ability of an object to take on multiple forms" correct="true" />
        <option alpha="d" text="The process of breaking down a complex problem into smaller, more manageable parts" correct="false" />
    </question>
    <question text="What is a class in object-oriented programming?">
        <option alpha="a" text="An instance of an object" correct="false" />
        <option alpha="b" text="A collection of variables" correct="false" />
        <option alpha="c" text="A blueprint or template for creating objects" correct="true" />
        <option alpha="d" text="A method for defining data types" correct="false" />
    </question>
    <question text="What is an object in object-oriented programming?">
        <option alpha="a" text="A blueprint or template for creating classes" correct="false" />
        <option alpha="b" text="A method for defining data types" correct="false" />
        <option alpha="c" text="An instance of a class" correct="true" />
        <option alpha="d" text="A collection of variables" correct="false" />
    </question>
</quiz>
